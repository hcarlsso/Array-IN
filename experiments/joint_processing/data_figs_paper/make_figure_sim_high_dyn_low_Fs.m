...
handleToPlot1 = plot(                               ...
    ...
    resRmseRoll2Cond.coarse_p_100Hz_IMU_100Hz.accelerometer_array_2nd_order,                                           ...
...
handleToPlot2 = plot(                               ...
    res_roll_2_100Hz_time,                                           ...
    resRmseRoll2Cond.coarse_p_100Hz_IMU_100Hz.accelerometer_array_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
...
handleToPlot3 = plot(                               ...
    res_roll_2_100Hz_time,                                           ...
    resRmseRoll2Cond.coarse_p_100Hz_IMU_100Hz.gyroscope_2nd_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
...
handleToPlot4 = plot(                               ...
    res_roll_2_100Hz_time,                                           ...
    resRmseRoll2Cond.coarse_p_100Hz_IMU_100Hz.gyroscope_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
...
strFilePath = 'exp_high_dyn_low_Fs';
