...
handleToPlot1 = plot(                               ...
    ...
    resRmseMiddleCond.coarse_p_100Hz_IMU_100Hz.accelerometer_array_2nd_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           aafPlotLineColor(1,:),       ...
    'Marker',          astrPlotMarkerType{2},       ...
    "MarkerIndices",   1:50:500);
%
handleToPlot2 = plot(                               ...
    res_roll_middle_100Hz_time,                                           ...
    resRmseMiddleCond.coarse_p_100Hz_IMU_100Hz.accelerometer_array_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           aafPlotLineColor(2,:),       ...
    'Marker',          astrPlotMarkerType{3},       ...
    'MarkerSize',      aiPlotMarkerSize(1),         ...
    "MarkerIndices",   20:50:500);

handleToPlot3 = plot(                               ...
    res_roll_middle_100Hz_time,                                           ...
    resRmseMiddleCond.coarse_p_100Hz_IMU_100Hz.gyroscope_2nd_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           aafPlotLineColor(3,:),       ...
    'Marker',          astrPlotMarkerType{4},       ...
    'MarkerSize',      aiPlotMarkerSize(1),         ...
    "MarkerIndices",   30:50:500);

handleToPlot4 = plot(                               ...
    res_roll_middle_100Hz_time,                                           ...
    resRmseMiddleCond.coarse_p_100Hz_IMU_100Hz.gyroscope_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           aafPlotLineColor(4,:),       ...
    'Marker',          astrPlotMarkerType{5},       ...
    'MarkerSize',      aiPlotMarkerSize(1),         ...
    "MarkerIndices",   40:50:500);
...
strFilePath = 'exp_low_dyn_low_Fs';
