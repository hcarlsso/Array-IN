...
handleToPlot1 = plot(                               ...
    ...
    resRmseMiddleCond.coarse.accelerometer_array_2nd_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           PlotLineColor.accelerometer_array_2nd_order,       ...
...
handleToPlot2 = plot(                               ...
    res_roll_2_500Hz_time,                                           ...
    resRmseMiddleCond.coarse.accelerometer_array_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           PlotLineColor.accelerometer_array_1st_order,       ...
...
handleToPlot3 = plot(                               ...
    res_roll_2_500Hz_time,                                           ...
    resRmseMiddleCond.coarse.gyroscope_2nd_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           PlotLineColor.gyroscope_2nd_order,       ...
...
handleToPlot4 = plot(                               ...
    res_roll_2_500Hz_time,                                           ...
    resRmseMiddleCond.coarse.gyroscope_1st_order,                                           ...
    'LineStyle',       astrPlotLineStyle{1},        ...
    'LineWidth',       afPlotLineWidth(1),          ...
    'Color',           PlotLineColor.gyroscope_1st_order,       ...
...
strFilePath = 'exp_low_dyn_high_Fs';
